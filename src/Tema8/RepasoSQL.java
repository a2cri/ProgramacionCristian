...
public class RepasoSQL {
    public static void main(String[] args) {
        ...
        try (Connection con2 = DriverManager.getConnection("jdbc:postgresql://ad-postgres.c7dcxanpavyz.us-east-1.rds.amazonaws.com:5432/hogwarts","postgres","12345678");
            ...
            //SQL12 busque ya que me daba error y era porque ya estaba creada
            ...
            try {
                ...
                if (e.getSQLState().equals("23505")) { // Código de error para duplicados
                    System.out.println("Nota: Nymphadora Tonks ya estaba en la base de datos, saltando insert...");
                } else {
                    throw e; // Si es otro error distinto, que sí salte
                }
            }
